          ...
          <Grid item xs={12} md={8}>
            <Card>
              ...
              <TabPanel value={tabValue} index={0}>
                {/* TrainerMonitoring component would go here */}
              </TabPanel>
              <TabPanel value={tabValue} index={1}>
                {/* AssessmentSampling component would go here */}
              </TabPanel>
              <TabPanel value={tabValue} index={2}>
                {/* LMSDataAnalysis component would go here */}
              </TabPanel>
              <TabPanel value={tabValue} index={3}>
                {/* FeedbackManagement component would go here */}
              </TabPanel>
